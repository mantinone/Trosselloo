...
const DownloadBoardButton = (props) => {
  return <Button type="invisible" className="MenuSideBar-button MenuSideBar-DownloadBoardButton" href={`/api/boards/${props.boardId}?download=1`}>Export Board</Button>
}
